...
html_theme_options = {
    ...
    'navbar_links': [
        ...
        ("contribute", "https://github.com/usnistgov/contracts", True),
    ],
...
texinfo_documents = [
    ('index', 'contracts', u'Contracts Documentation',
     u'Faical Yannick P. Congo', 'contracts', 'Cloud of Reproducible Records',
     'Miscellaneous'),
]
...
def setup(app):
    ...
    app.add_stylesheet('contracts.css')
